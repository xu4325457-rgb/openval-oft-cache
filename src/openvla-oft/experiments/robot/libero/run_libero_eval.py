...
def run_task(
    ...
    for episode_idx in tqdm.tqdm(range(start_episode_idx, cfg.num_trials_per_task)):
        ...
        # Save replay video
        save_rollout_video(
            replay_images, total_episodes, success=success, task_description=task_description, log_file=log_file, view="primary"
        )
        save_rollout_video(
            replay_images_wrist, total_episodes, success=success, task_description=task_description, log_file=log_file, view="wrist"
        )
